  ...
  return (
    <div className="flex items-center justify-center h-screen w-screen absolute top-0 right-4  bg-gray-100 bg-opacity-30">
      <div className="bg-white relative p-10 w-[70rem] rounded-lg shadow-lg mt-96 md:m-0">
        <div
          className="bg-black text-white w-8 h-8 rounded-full  flex justify-center items-center absolute right-0 top-0 cursor-pointer font-bold mt-52 md:mt-0
          "
        ...
        <div className="mt-52 md:mt-0">
          <h1 className="font-bold text-lg md:text-xl lg:text-3xl mb-3">Add Cases</h1>
          <div className="md:grid md:grid-cols-2 lg:grid lg:grid-cols-3 gap-4">
            <div>
              <label className="text-sm md:text-lg">Reg No:</label>
              <input
                type="number"
            ...
            <div>
              <label className="text-sm md:text-lg">CNR No:</label>
              <input
                type="number"
                className={inputStyles}
            ...
            <div>
              <label className="text-sm md:text-lg">Client Name: </label>
              <input
                type="text"
                className={inputStyles}
            ...
            <div>
              <label className="text-sm md:text-lg">Case Name: </label>
              <input
                type="text"
                className={inputStyles}
            ...
            <div>
              <label className="text-sm md:text-lg">Client Status</label>
              <input
                type="text"
                className={inputStyles}
            ...
            <div className="">
              <label className="text-sm md:text-lg">I.A</label>
              <input
                type="text"
                className={inputStyles}
              ...
              />
              <button
                className="bg-blue-500 mt-5 px-3 py-2 rounded-md shadow-sm text-white hover:bg-blue-700 "
                onClick={addIa}
              >
                Add I. A
              </button>
            ...
            <div>
              <label className="text-sm md:text-lg">ACT</label>
              <input
                className={inputStyles}
                placeholder="Enter I.A"
            ...
            <div>
              <label className="text-sm md:text-lg">Opposite Party: </label>
              <input
                className={inputStyles}
            ...
            <div>
              <label className="text-sm md:text-lg">Opposite Advocate</label>
              <input
                className={inputStyles}
            ...
            <div>
              <label className="text-sm md:text-lg">Case Description</label>
              <textarea
                className={inputStyles}
          ...
          <div className="mt-5 flex gap-5 items-center justify-content">
            <button
              className="bg-green-500 px-3 py-2 rounded-md shadow-sm text-white"
              onClick={handleSave}
            >
              Save
            </button>
