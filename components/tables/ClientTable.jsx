          ...
          <table className="border  w-full text-md text-center">
            ...
            {myClients.filter(client  => client.name.toLowerCase().includes(searchItem.toLowerCase())).map((client, index) => (
               ...
               <tr className="h-10">
                 ...
                 <td className="py-3">
                   <button
                     className="text-white bg-blue-500  px-2 py-1 rounded-md shadow-sm mr-2 "
                     onClick={() => setIsClicked(true)}
                   >
                     Edit
                   </button>
                   <button
                     className="bg-red-500 px-1 py-1 rounded-md shadow-sm text-white"
                 ...
                 <td className="flex justify-center items-center pt-3">
                   <ReactWhatsapp
                     className="flex gap-1 shadow-md rounded-full"
                     number={`+91 ${client.mobile}`}
                     message="Hi"
                   >
                     <svg
                       xmlns="http://www.w3.org/2000/svg"
                       viewBox="0 0 448 512"
                       className="fill-green-400 h-7"
                     >
